...
const SidebarMenu = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 h-full ${isOpen ? 'w-64' : 'w-0'} bg-gray-800 text-white transition-all duration-300`}>
      <button
      ...
      {isOpen && (
        <div className="flex flex-col items-center mt-16">
          <h2 className="text-lg font-bold mb-4" style={{ color: 'black' }}>Menú</h2>
          <ul>
            <li className="mb-4">
